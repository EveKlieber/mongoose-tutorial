...
async function getPersonWithFavoritWineInfos(){
  ...
  const winePeopePopulated = await Person.where("favoriteWines").exists(true).populate("favoriteWines")
  console.log( "winePeopePopulated: ", JSON.stringify(winePeopePopulated, null, 2) );
